...
function BackgroundCircles({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center z-0'>
      <div className='absolute border border-[#0ea5e9] rounded-full h-[200px] w-[200px] mt-52 animate-ping'/>
      ...
      <div className='rounded-full border border-[#0ea5e9] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse'/>
